...
public class MilenitbricksBlock extends DimensionAdventureModElements.ModElement {
	@ObjectHolder("dimension_adventure:milenitbricks")
	public static final Block block = null;
	public MilenitbricksBlock(DimensionAdventureModElements instance) {
		super(instance, 20);
	}
