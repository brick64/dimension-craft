...
public class MilenotdirtBlock extends DimensionAdventureModElements.ModElement {
	@ObjectHolder("dimension_adventure:milenotdirt")
	public static final Block block = null;
	public MilenotdirtBlock(DimensionAdventureModElements instance) {
		super(instance, 9);
	}
